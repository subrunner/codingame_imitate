class Init extends Game {
  ...
  successMessage = "Hervorragend! Du hast die erste Hürde gemeistert und kannst nun zu echten Aufgaben weiter gehen!<p>Mein Vorschlag: <a href='#game:thor' onclick='closePopup()'>Thor - Find the Light</a>";
